    ...
    healthcheck: (flightCheckOnStartUp, log, callback) => {
        ...
        async.each(Object.keys(clients), (location, cb) => {
            ...
            async.parallel([
                ...
                console.log('==============================')
                console.log('in multipleBackendGateway healthcheck');
                console.log('flightCheckOnStartUp', flightCheckOnStartUp);
                console.log('log', log);
                console.log('callback', callback);
                console.log('****** externalResp', externalResp);
                // resp here is undefined: means we got [undefined, ?] for externalResp
